...
describe('Content Security Policies', function() {
  ...
  it('should insert headers', async function() {
    ...
    expect(csp_headers).includes('default-src \'self\' example1.com example2.com');
    expect(csp_headers).includes('script-src \'self\' example1.com self use-nonce');
    expect(csp_headers).includes('connect-src \'self\' example1.com example3.com;');
    expect(csp_headers).includes('font-src \'self\' example1.com fonts.gstatic.com');
